...
#         # scores = result
#         solver.Add(solver.Sum(variable * result[name] for (name, variable) in variables.items()) <= threshold)
...
#             solver.SetHint([variable], [variable.solution_value()])

#         solver.Add(solver.Sum(variable * result[name] for (name, variable) in variables.items()) <= round(solver.Objective().Value()))
